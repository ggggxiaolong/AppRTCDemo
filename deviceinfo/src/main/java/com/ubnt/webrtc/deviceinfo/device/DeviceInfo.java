package com.ubnt.webrtc.deviceinfo.device;
...
import com.ubnt.webrtc.deviceinfo.permission.PermissionUtils;
import java.io.File;
...
public class DeviceInfo {
  ...
  @RequiresApi(api = Build.VERSION_CODES.ICE_CREAM_SANDWICH) public final String getRadioVer() {
  ...
  @SuppressWarnings("MissingPermission") public final String getWifiMacAddress(Context context) {
  ...
  @SuppressWarnings("MissingPermission") public final List<String> getEmailAccounts() {
  ...
  @SuppressWarnings("MissingPermission") public String getPhoneNumber() {
    if (!permissionUtils.isPermissionGranted(Manifest.permission.READ_PHONE_STATE)) {
      throw new RuntimeException("Read Phone State permission not granted!");
    }
  ...
  public String getOperator() {
    ...
    if (operatorName == null) operatorName = telephonyManager.getSimOperatorName();
    return operatorName;
  }
